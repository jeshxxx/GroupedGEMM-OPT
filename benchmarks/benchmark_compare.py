"""
Focused benchmark: Standard gmm vs CUTLASS/cuBLAS Auto.
...
def main():
    ...
    for K, N in dim_configs:
        ...
        for total_tokens in token_counts:
            ...
            # Auto: hybrid CUTLASS/cuBLAS
            auto_lat = benchmark_fn(
            ...
            print(f"  {total_tokens:>8}  {avg_m:>8}"
                  ...
                  f"  {auto_lat:>10.3f} {auto_tflops:>12.2f}"
                  f"  {backend:>12}"
    ...
    print(f"\n{'=' * 120}")
    print("Speedup > 1.0x means Auto is faster than Standard gmm.")
    print("=" * 120)
