"""
Head-to-head benchmark: Standard gmm vs TE GroupedLinear.

Sweeps total_tokens in [111600, 892800] with num_experts=64, random distribution, BF16.
Three (K, N) configs: (2048,1280), (2048,2560), (1280,2048).

Two isolated phases to avoid cross-contamination.
"""
...
def main():
    ...
    print("=" * 110)
    print(f"Standard gmm vs TE GroupedLinear  |  GPU: {torch.cuda.get_device_name(0)}")
    ...
    for K, N in dim_configs:
        ...
        # ── Phase 2: TE GroupedLinear (isolated) ──
        torch.cuda.synchronize()
        for total_tokens in token_counts:
